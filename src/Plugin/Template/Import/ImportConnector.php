...
<p><?php echo wp_kses_post( __( 'XML or CSV file import. Import a CSV or XML file using a link. Learn more about the import process and <b>Read more in the</b> <a href="https://wpdesk.link/dropshipping-import" class="docs-url" target="_blank">plugin documentation &rarr;</a>', 'dropshipping-xml-for-woocommerce' ) ); ?></p>
<hr>
<?php
$form->form_start(
	[
