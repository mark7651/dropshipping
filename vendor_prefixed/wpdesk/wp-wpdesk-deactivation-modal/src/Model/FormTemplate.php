...
class FormTemplate
{
    ...
    {
        return empty($this->form_desc) ? __('If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'dropshipping-xml-for-woocommerce') : $this->form_desc;
    }
}
