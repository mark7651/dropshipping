...
class PluginAssetsLoaderAction implements Hookable, Conditional
{
    ...
    {
        return \strpos($this->request->get_param('server.REQUEST_URI'), 'edit.php?post_type=product') > 0 || $this->plugin_helper->is_plugin_page($this->request->get_param('get.page')->getAsString(), $this->request->get_param('get.action')->getAsString());
    }
