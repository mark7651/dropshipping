 ...
 */
class CsvSidebarViewerService implements Displayable
{
    const FIRST_PAGE = 1;
    /**
     * @var Renderer
     ...
     */
    private $uid = '';
    public function __construct(Renderer $renderer, XmlAnalyser $xml_analyser, FileLocatorService $file_locator, SidebarViewerService $sidebar_viewer_service, string $uid)
    {
