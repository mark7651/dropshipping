...
namespace DropshippingXmlFreeVendor\Psr\Log\Test;

use DropshippingXmlFreeVendor\Psr\Log\LoggerInterface;
use DropshippingXmlFreeVendor\Psr\Log\LogLevel;
use DropshippingXmlFreeVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('DropshippingXmlFreeVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('DropshippingXmlFreeVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('DropshippingXmlFreeVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
